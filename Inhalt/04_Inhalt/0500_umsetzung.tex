...
5: reward = walkedDistanceReward * angleReward
6: (avgSpeedReward * angledToTargetReward * calmCenterAngleReward) + stagnationPenalty
7: (avgSpeedReward * movementInTargetDirectionReward * calmCenterAngleReward)
