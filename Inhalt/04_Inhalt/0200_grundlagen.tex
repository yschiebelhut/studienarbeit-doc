...
\subsection{Unity Machine Learning Agents Toolkit\todo{Abkürzung?}}
Historie und Funktionsweise
Lern-Algorithmen, die zur Verfügung stehen und welcher warum genutzt wird
...
ML-Agents besteht aus folgenden high-level Komponenten:
\begin{itemize}
    \item \textbf{Trainingsumgebung:}
...
- kam in der Vorgängerarbeit zum Einsatz
