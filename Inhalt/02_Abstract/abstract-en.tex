...
The trained model only allows the robot to move in one direction.

\vspace{0.25cm}

This thesis explores the extension of this model to allow the ability to follow a given path while avoiding obstacles along the way.
